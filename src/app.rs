...
const APP_ICON: &[u8] = include_bytes!("../resources/icons/hicolor/scalable/apps/io.github.decksters-lab.DinitDash.svg");
...
pub struct AppModel {
    ...
    pub(crate) system_services: Vec<DinitService>,
    pub(crate) user_services: Vec<DinitService>,
    pub(crate) selected_service: Option<DinitService>,
...
impl cosmic::Application for AppModel {
    ...
    const APP_ID: &'static str = "io.github.decksters-lab.DinitDash";
